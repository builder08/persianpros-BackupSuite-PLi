...
class BackupStart(Screen):
	...
	def flashimage(self):
		...
		if model in ("vuduo", "vusolo", "vuultimo", "vuuno") or model.startswith("ebox"):
			files = "^.*\.(zip|bin|jffs2)"
		elif "4k" or "uhd" in model or model in ("hd51", "hd60", "hd61", "h7", "sf4008", "sf5008", "sf8008", "sf8008m", "vs1500", "et11000", "et13000", "multibox", "multiboxplus", "e4hdultra", "ustym4kpro", "pulse4k", "pulse4kmini"):
			files = "^.*\.(zip|bin|bz2)"
		...
		if self["key_green"].getText() == _("Run flash"):
			...
			if dirname:
				...
				if model.startswith("dm"):
					...
					if model in ("hd51", "h7", "sf4008", "sf5008", "sf8008", "sf8008m", "vs1500", "et11000", "et13000", "bre2ze4k", "spycat4k", "spycat4kmini", "protek4k", "e4hdultra", "arivacombo", "arivatwin", "ustym4kpro") or model.startswith(("anadol", "axashis4", "dinobot4", "ferguson4", "mediabox4", "axashisc4")):
						backup_files = [("kernel.bin"), ("rootfs.tar.bz2")]
						no_backup_files = [("kernel_cfe_auto.bin"), ("rootfs.bin"), ("root_cfe_auto.jffs2"), ("root_cfe_auto.bin"), ("oe_kernel.bin"), ("oe_rootfs.bin"), ("kernel_auto.bin"), ("uImage"), ("rootfs.ubi")]
						text += "kernel.bin, rootfs.tar.bz2"
					elif model in ("h9", "h9se", "h9combo", "h9combose", "i55plus", "i55se", "h10", "hzero", "h8", "dinobotu55", "iziboxx3", "dinoboth265", "axashistwin", "protek4kx1"):
					...
					elif model in ("hd60", "hd61", "multibox", "multiboxplus", "pulse4k", "pulse4kmini"):
